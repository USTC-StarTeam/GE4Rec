...
printed_name = [f'Group{idx}' for idx in range(2)]
printed_name = ['Discriminative', '(c.1) Random Predict (10)', '(c.2) Masked predict (10)', '(c.3) Field-wise Masked predict (10)', '(c.4) Hard Masked predict (10)', 'Predict all (ours)']
...
group_auc_dict = {
    'Avazu': {
        'DCNv2': [0.792762, 0.792364, 0.792931, 0.793102],
    },
    'Criteo': {
...
save_dir = f'./figure/final/ab_target/auc/{dataset_name}'
