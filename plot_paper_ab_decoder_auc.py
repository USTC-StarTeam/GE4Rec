...
printed_name = ['Discriminative', '(b.1) Field-shared MLP', '(b.2) Linear decoder', '(b.3) Stacking layers', '(b.4) Self-attention', 'Ours']
...
group_auc_dict = {
    'Avazu': {
        'DCNv2': [0.792891, 0.792318, 0.792931, 0.792901],
    },
    'Criteo': {
...
save_dir = f'./figure/final/ab_decoder/auc/{dataset_name}'
