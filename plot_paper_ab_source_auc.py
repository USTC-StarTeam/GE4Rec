...
printed_name = ['Discriminative', '(a) Own for all fields', '(b) All for high cardinality fields', '(c) All for low cardinality fields', 'All for all fields (Ours)']
...
group_auc_dict = {
    'Avazu': {
        'DCNv2': [0.792635, 0.792943, 0.793141],
    },
    'Criteo': {
...
save_dir = f'./figure/final/ab_source/auc/{dataset_name}'
